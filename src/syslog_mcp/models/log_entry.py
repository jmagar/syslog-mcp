...
class LogLevel(str, Enum):
    ...
    @classmethod
    def normalize(cls, value: Union[str, int]) -> "LogLevel":
        """
...
class LogEntry(BaseModel):
    ...
    device: constr(min_length=1, max_length=255) = Field(
        ...,
    ...
    message: constr(min_length=1, max_length=8192) = Field(
        ...,
    ...
    process_name: Optional[constr(max_length=64)] = Field(
        None,
        description="Name of the process that generated the log",
        examples=["sshd", "nginx", "mysqld"]
    )
    
    source_ip: Optional[Union[IPv4Address, IPv6Address]] = Field(
        None,
    ...
    def validate_device(cls, v: Any) -> str:
        ...
        return device.lower()  # Normalize to lowercase
    ...
    @classmethod
    def validate_facility(cls, v: Any) -> Optional[str]:
        """
    ...
    @classmethod
    def validate_source_ip(cls, v: Any) -> Optional[Union[IPv4Address, IPv6Address]]:
        """
