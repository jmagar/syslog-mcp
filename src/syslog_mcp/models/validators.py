...
def validate_facility_name(value: Optional[str]) -> Optional[str]:
    """
...
def validate_query_string(value: Optional[str], max_length: int = 1024) -> Optional[str]:
    """
...
def create_range_validator(
    ...
    Returns:
        Validator function
    """
    def validate_range(value: Union[int, float]) -> Union[int, float]:
