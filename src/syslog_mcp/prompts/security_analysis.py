...
def register_security_analysis_prompts(mcp: FastMCP) -> None:
    ...
    def investigate_security_incident(
        device: Optional[str] = Field(None, description="Target device to investigate (leave blank for all devices)"),
...
"""
    ...
    def security_health_assessment(
        ...
        focus_device: Optional[str] = Field(None, description="Specific device to focus assessment on")
    ) -> str:
        """
