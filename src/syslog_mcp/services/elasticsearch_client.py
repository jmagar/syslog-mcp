...
class ElasticsearchClient:
    ...
    async def _test_connection(self) -> None:
        ...
        try:
            ...
            raise ElasticsearchAuthenticationError(error_msg, auth_method, e) from e
    ...
    async def get_cluster_health(self, timeout: str = "30s") -> dict[str, Any]:
        ...
        try:
            async def health_operation():
                ...
                health = await self._client.cluster.health(timeout=timeout)
    ...
    def _parse_elasticsearch_hit(self, hit: dict[str, Any]) -> "LogEntry":
        ...
        # Create LogEntry with proper field mapping
        log_entry = LogEntry(
