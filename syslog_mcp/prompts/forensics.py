...
def register_forensics_prompts(mcp: FastMCP) -> None:
    ...
    def log_forensics_investigation(
        ...
        target_device: str | None = Field(None, description="Specific device to investigate")
    ) -> str:
        """
...
"""
    ...
    def root_cause_analysis(
        ...
        affected_systems: str | None = Field(None, description="Systems affected (device names, comma-separated)")
    ) -> str:
        """
