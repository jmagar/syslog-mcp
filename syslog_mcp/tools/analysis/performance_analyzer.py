...
def _calculate_activity_statistics(timeline: list[dict[str, Any]]) -> dict[str, Any]:
...
def _identify_activity_anomalies(timeline: list[dict[str, Any]]) -> list[dict[str, Any]]:
...
def _analyze_error_trends(error_timeline: list[dict[str, Any]], hours: int) -> dict[str, Any]:
...
def _calculate_consistency_score(activity_timeline: list[dict[str, Any]]) -> dict[str, Any]:
...
def _calculate_reliability_score(error_timeline: list[dict[str, Any]], hours: int) -> dict[str, Any]:
...
def _get_utilization_recommendations(score: float, pattern_analysis: dict[str, Any], total_periods: int = 0) -> list[str]:
