...
from ..models.log_entry import LogLevel
from ..models.query import LogSearchQuery, SearchFilter, SortOrder, TimeRange
...
class SearchLogsParameters(BaseModel):
    ...
    @classmethod
    def validate_time_range(cls, v: Any, info: ValidationInfo) -> Any:
